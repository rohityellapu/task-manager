                        ...
                        <table className='table-auto'>
                            <thead>
                                <tr className='m-2 p-2 bg-gray-600'>
                                    <th className='w-20 lg:w-56 text-lg lg:text-2xl p-2 m-2 border-2'>Activity</th>
                                    <th className='w-20 lg:w-56 text-lg lg:text-2xl p-2 m-2 border-2'>Status</th>
                                    <th className='w-20 lg:w-56 text-lg lg:text-2xl p-2 m-2 border-2'>Time Taken (HH:MM:SS) </th>
